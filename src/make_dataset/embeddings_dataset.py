...
def main():
    ...
    for split in splits:
        ...
        # save metadata (labels and dataset) 
        meta_data = df[["dataset", "is_human"]]
        meta_data_out_file = out_file.parents[0] / f"{split}_metadata.parquet"
        meta_data.to_parquet(meta_data_out_file)
